...
public class CharacterBean implements Serializable {
    ...
    private String worstMemory;
    private String trophy;
    private String failure;
    private String secret;
    private String objective;
    private String anedocte;
    ...
    public String getWorstMemory() {
        return worstMemory;
    }

    public void setWorstMemory(String worstMemory) {
        this.worstMemory = worstMemory;
    }
    ...
    public String getAnedocte() {
        return anedocte;
    }

    public void setAnedocte(String anedocte) {
        this.anedocte = anedocte;
    }
